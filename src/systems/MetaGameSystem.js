...
const CHANGELOG_ENTRIES = [
  {
    ...
    title: '雪谷重构为林海悬崖山城',
    items: [
      '第一关整体重构为林海上方的高耸白色山脊：战斗区收束为狭长山顶，低处以深浅错落的低多边形林冠表现显著落差。',
      '山顶中央改为浅色山石，偏黄的青绿色草带只沿崖缘生长，并形成长短不一的垂落草片；取消横贯山顶的可见道路。',
      '悬崖加入多层错位折面、裂缝、岩台与外凸岩石节点，山壁轮廓和明暗不再由整块简单竖直面组成。',
      '浅陶红屋顶建筑沿山脊两侧高低错落布置，兼作临崖护栏与尺度参照；原有基地、敌营、祭坛和战斗路线保持可用。'
    ]
  },
  {
    date: '2026-08-20',
