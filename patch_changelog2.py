...
replacement = """
    items: [
      ...
      '去除了主界面中间多余的底框，让徽章与木质按钮直接融入全屏地图背景中，并在徽章后方增加了一面水平的中世纪红色战旗。修复了徽章阴影被截断的显示错误，并移除了徽章过强的发光效果与多余的下垂绑带。',
"""

js = re.sub(r"items:\s*\[\s*'全面颠覆Web样式布局[^\\]*?去除了主界面中间多余的底框，让徽章与木质按钮直接融入全屏地图背景中，并在徽章后方增加了一面垂直悬挂的中世纪红色战旗。修复了徽章阴影被截断的显示错误。',", replacement.strip(), js, flags=re.DOTALL)
