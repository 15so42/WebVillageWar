          ...
          <div class="med-menu-board">
            ...
            <div class="med-menu-divider-epic">
                <svg width="200" height="20" viewBox="0 0 200 20">
                    <path d="M 0 10 L 80 10 L 90 5 L 100 15 L 110 5 L 120 10 L 200 10" stroke="#3e2a1b" stroke-width="2" fill="none" opacity="0.5"/>
                    <circle cx="100" cy="10" r="3" fill="#3e2a1b" opacity="0.8"/>
                </svg>
            </div>
            ...
            <nav class="med-menu-nav" aria-label="主菜单">
              ...
              <button class="med-btn-epic-danger" type="button" data-action="clear-save">焚毁盟约 (清档)</button>
            </nav>
